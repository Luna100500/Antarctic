...
/* harmony import */ var _modules_catalog__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/catalog */ "./js/modules/catalog.js");
/* harmony import */ var _modules_catalog__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(_modules_catalog__WEBPACK_IMPORTED_MODULE_5__);
...
var item = document.querySelectorAll(".catalog__info");
var preview = document.querySelectorAll(".catalog__preview");
...
Object(imask__WEBPACK_IMPORTED_MODULE_0__["default"])(document.querySelector("#phone-mask"), maskOptions);
...
L.marker([59.938823961800495, 30.3230581269971], {
  icon: pinIcon
}).addTo(map);
...
var hederMain = document.querySelector(".header");
var logo = document.querySelector(".header__logo-svg");
var navigation = document.querySelector(".header__nav-list");
var cross = document.querySelector(".header__cross-button");
var toggle = document.querySelector(".header__toggle-button");
var wrapper = document.querySelector(".wrapper");
var wrapperOverlay = document.querySelector(".wrapper__overlay");
var navItem = document.querySelectorAll(".header__nav-link");
...
document.addEventListener("click", function (event) {
  if (wrapperOverlay.contains(event.target)) closeMenu(), removeOverlay(), logo.style.fill = "#f9fbfd";
});
navigation.onclick = function (event) {
  var navTarget = event.target.closest(".header__nav-link"); // (1)
...
var setLogo = function setLogo() {
  ...
  if (windowLength < 768 && navigation.classList.contains("header__nav-list--opened")) {
    logo.style.fill = "#011c40";
  }
};
...
/*!******************************!*\
  !*** ./js/modules/scroll.js ***!
  \******************************/
/*! exports provided: createSmoothScroll */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "createSmoothScroll", function() { return createSmoothScroll; });
...
var smoothLinks = document.querySelectorAll('span[href^="#"]');
var createSmoothScroll = function createSmoothScroll() {
  if (smoothLinks.length) {
    _toConsumableArray(smoothLinks).forEach(function (link) {
      var id = link.getAttribute("href");
      if (id.length > 1) {
        var targetBlock = document.querySelector(id);
        if (targetBlock) {
